...
describe Skydrive::Folder do
  it "#parse_parent_uri without uri" do
    ...
    folder.parent_uri.should be_nil
  end
  ...
  it "#parse_parent_uri with uri" do
    ...
    folder.parse_parent_uri
    folder.parent_uri[:uri].should eq("https://instructure-my.sharepoint.com/personal/ericb_instructure_onmicrosoft_com/_api/Web/Lists(guid'85208d43-a3be-43ca-a737-f6913578427b')')")
  end
end
